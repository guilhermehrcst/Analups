...
export function ProductCard({ product, size = 'default', revealDelay = 0 }: ProductCardProps) {
  ...
  return (
    <a
      ...
      className={[styles.card, size === 'large' ? styles.large : '', 'reveal', visible ? 'is-visible' : ''].join(
        ' ',
      )}
    >
      <AspectImage
